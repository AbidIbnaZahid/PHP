...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <form action="services-post.php" method="POST">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                <h3 class="card-body-title text-center mb-5">Add Services</h3>
                <div class="row">
                    <label class="col-sm-4 form-control-label">Services Name: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input type="text" class="form-control" name="service_name">
                        <!-- Error massage -->
                        <small class="text-danger"><?= (isset($_SESSION['service_name_empty'])) ? $_SESSION['service_name_empty'] : '' ?></small>
                        <!-- Error massage -->
                    </div>
                </div><!-- row -->
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">Services Description: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input type="text" class="form-control" name="service_desc">
                        <!-- Error massage -->
                        <small class="text-danger"><?= (isset($_SESSION['service_desc_empty'])) ? $_SESSION['service_desc_empty'] : '' ?></small>
                        <!-- Error massage -->
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">Services Icon:<span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input id="service_icon" type="text" class="form-control" name="service_icon" readonly>
                        <!-- Error massage -->
                        <small class="text-danger"><?= (isset($_SESSION['service_icon_empty'])) ? $_SESSION['service_icon_empty'] : '' ?></small>
                        <!-- Error massage -->
    ...
    unset($_SESSION['service_name_empty']);
    unset($_SESSION['service_desc_empty']);
    unset($_SESSION['service_icon_empty']);
    ?>